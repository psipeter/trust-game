...
# test_adaptivity(learner_type="deep-q-learning", n_learners=3, n_train=300, seed=0, load=load)
...
test_t4tv(learner_type="instance-based", n_learners=20, n_train=500, seed=0, load=load)
