...
testers = [adaptive('trustee', 'attrition')]
# testers = [adaptive('trustee', 'turn_based')]


play_tournament(investors, trustees, testers, tournament_type, learner_plays, n_train)


# test_adaptivity(n_learners=10, learning_rate=3e-4, n_train=2000, n_test=100, n_inputs=15, seed=0)