...
# test_adaptivity(learner_type="deep-q-learning", n_learners=10, n_train=200, seed=0)
# test_adaptivity(learner_type="instance-based", n_learners=10, n_train=200, seed=0)
test_adaptivity(learner_type="nengo-q-learning", n_learners=2, n_train=200, seed=0)
