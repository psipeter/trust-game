...
# test_adaptivity(learner_type="tabular-q-learning", n_learners=3, n_train=3000, n_test=10, seed=0)
...
test_adaptivity(learner_type="nengo-q-learning", n_learners=1, n_train=4000, n_test=10, seed=0)
