...
investors = [test_forgive('investor')]
...
# trustees = [test_forgive('trustee')]
# trustees = [adapt_gen('trustee', O=0, delta=0.5)]
# trustees = [adapt_gen('trustee', O=1.0, delta=0.5)]
...
# testers = [test_forgive('trustee')]
testers = [test_forgive('investor')]
