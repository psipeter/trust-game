...
# test_adaptivity(learner_type="deep-q-learning", n_learners=5, n_train=1000, seed=0, load=load)
...
test_adaptivity(learner_type="nengo-q-learning", n_learners=2, n_train=100, seed=0)
